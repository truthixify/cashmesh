...
| PostgreSQL repository integration | `pnpm test:integration` | Migration, invoice/request atomicity, keyset history, freshness, restart, concurrency, corruption, and rollback behavior |
