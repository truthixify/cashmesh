...
| PostgreSQL repository integration | `pnpm test:integration` | Migration, invoice/request atomicity, keyset and proof-state history, freshness, proof-reference reservation, restart, concurrency, corruption, and rollback behavior |
